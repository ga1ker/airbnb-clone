...
const ReservationSideBar: React.FC<ReservationSideBarProps> = ({property, userId}) => {
    ...
    if (userId) {
        if (dateRange.startDate && dateRange.endDate) {
            ...
            if (response.success) {
                console.log('kekemuy bien reservado');
                
            } else {
                console.error('kekemuy nonon');
            }
        }
        } else {
            loginModal.open();
    ...
    return(
        <aside className="p-6 col-span-2 rounded-xl border border-gray-300 shadow-xl">
            ...
            <div className="mb-6 p-3 border border-gray-400 rounded-xl">
                ...
                <select onChange={(e) => setGuests(e.target.value)} value={guests} className="w-full -ml-1 text-sm">
                    {
            ...
            <div
                ...
                className="w-full mb-6 py-6 text-center text-white bg-airbnb rounded-md hover:bg-airbnb-dark">
                Book
            </div>
